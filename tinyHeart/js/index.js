(function(){
	...
	fruitObject.prototype.drawFruit = function(){
		for(var i =0;i< this.num; i++){
			if(this.alive[i]){
				...
				if(this.size[i] <= 5="" 16){="" 长大状态="" this.grow[i]="false;" this.size[i]="" +="this.speed[i]" *="" diffframetime="" 0.8;="" }else{="" 已经长大,向上漂浮="" this.y[i]="" -="this.speed[i]" diffframetime;="" }="" var="" pic="this.orange;" if(this.type[i]="=" 'blue')="" ctx2.drawimage(pic,="" this.x[i]="" 0.5,="" this.size[i],="" this.size[i]);="" if(this.y[i]="" <="" 8){="" this.alive[i]="false;" fruitobject.prototype.born="function(i){" aneid="Math.floor(Math.random()" aneob.num);="" 果实的横坐标="" 果实的总坐标="" flag="Math.random();" if(flag="" 0.1){="" this.type[i]="blue" ;="" fruitobject.prototype.dead="function(i){" function="" computefruit()="" {="" 计算屏幕上的果实数量="" count="0;" for(var="" i="0;" fruitob.num;="" i++){="" if(fruitob.alive[i])="" ++;="" if(count="" 15){="" bornfruit();="" 出生一个果实="" return="" false;="" bornfruit()="" 循环30个果实，如果状态为false，则让它出生="" if(!fruitob.alive[i]){="" fruitob.born(i);="" ****************************************************************************************画布1上绘制东西****************="" **********************************************************************************************************************="" window.can1app="{};" ********************************************************************="" 定义鱼妈妈类*********************="" momobject="function(){" this.x="0;" this.y="0;" this.angle;="" 大鱼的角度="" this.momtailarr="[];" this.momtailtimer="0;" this.momtailindex="0;" this.momeyearr="[];" this.momeyetimer="0;" this.momeyeindex="0;" this.momeyeinterval="1000;" this.momorangearr="[];" 大鱼的橙色身体数组="" this.mombluearr="[];" 蓝色身体数组="" this.mombodyindex="0;" momobject.prototype.init="function(){" 0.5;="" this.angle="0;" 8;="" 大鱼尾巴="" this.momtailarr[i]="new" image();="" this.momtailarr[i].src="imgUrl" 'bigtail'+="" +'.png';="" 2;="" 大鱼眼睛="" this.momeyearr[i]="new" this.momeyearr[i].src="imgUrl" 'bigeye'+="" this.momorangearr[i]="new" 大鱼橙色身体="" this.momorangearr[i].src="imgUrl" 'bigswim'+="" this.mombluearr[i]="new" 大鱼蓝色身体="" this.mombluearr[i].src="imgUrl" 'bigswimblue'+="" momobject.prototype.drawmom="function(){" lerp="" x,y="" 让大鱼的坐标值倾向于鼠标位置，然后绘制大鱼="" this.x,="" 0.96);="" this.y,="" 0.98);="" angle="" 让大鱼的角度倾向于鼠标的角度="" deltax="mx" this.x;="" 横坐标差="" deltay="my" this.y;="" 纵坐标差="" beta="Math.atan2(deltaY," deltax)="" math.pi;="" 目标角度="" this.angle,="" 0.6);="" 获得每一次旋转的角度="" if(this.momtailtimer=""> 50){
	...
	scoreObject.prototype.drawScore = function(){
		...
		if(scoreOb.strength <= 3){="" ctx1.fillstyle="red" ;="" }="" ctx1.filltext(scoreob.strength,="" 710,="" 45);="" if(scoreob.gameover){="" this.alpha="" +="diffframetime" *="" 0.0005;="" if(this.alpha=""> 1){
				this.alpha = 1;
			}
